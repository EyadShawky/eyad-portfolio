...
import DIGITISED from '../images/DIGITISED.png';
import aallie from '../images/aallie.png';

const Projects = () => {
    // Array of project objects with titles and background images
    const projects = [
        { title: 'DIGITISED', background: DIGITISED, link: 'https://digitised.net/' },
        { title: 'Aallie', background: aallie, link: 'https://aallie.com/Home' },
        { title: 'Clipify', background: ClipfyBackground, link: 'https://www.behance.net/gallery/194226521/clipify' },
