            ...
            <div className='container service'>
                <div className='d-flex justify-content-center text-center'>
                    <div>
                        ...
                        <p className='text-muted'>Crafting Web Experiences! From sleek designs to dynamic apps, <br /> I bring your digital ideas to life. Let's create a standout online presence together!</p>
                    </div>
                </div>
